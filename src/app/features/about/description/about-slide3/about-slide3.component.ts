...
@Component({
    ...
    <div class="slide-content3">
      <div class="side-description fadeIn">
        ...
        <p>
          ...
          sempre em busca de novos desafios para crescer e evoluir. Com uma
          trajetória marcada por disciplina e dedicação, venho de uma
        ...
        <p>
          ...
          pronto para contribuir com meu potencial em projetos que me desafiem a
          aprender ainda mais. Fique à vontade para explorar meu portfólio e
          ...
          adaptação, estou à disposição para conversar sobre como posso agregar
          valor à sua equipe.
        </p>
        <p>Vamos conversar!</p>
      </div>
  ...
  `,
  styleUrl: './about-slide3.component.css',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class AboutSlide3Component {}
